      ...
      <div class="col-12 ">
        <div class="posts-grid">
          <div class="row">
            ...
            <div class="col-12 col-lg-4 ">
              <div class="post-box">     <a class="post-link" href="#0" title="we are able to building your dream website">
                  <div class="post-img-wrapper  "><img class=" parallax-img   post-img" loading="lazy" src="{{ asset('assets/images/blog/post-images/4.jpg') }}" alt=""/><span class="post-date"><span class="day">15 </span>aug 2022     </span></div></a>
                <div class="post-summary">
                  ...
                  <div class="post-text"><a class="post-link" href="#0">
                    ...
                    <p class="post-excerpt">Lorem ipsum dolor sit, amet consectetur adipisicing elit.Iure nulla dolorem, voluptates molestiae</p><a class="read-more" href="#0" title="we are able to building your dream website">read more<i class="bi bi-arrow-right icon "></i></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-12 col-lg-4 ">
              <div class="post-box">     <a class="post-link" href="#0" title="data analysis and the big impact on industry">
                  <div class="post-img-wrapper  "><img class=" parallax-img   post-img" loading="lazy" src="{{ asset('assets/images/blog/post-images/5.jpg') }}" alt=""/><span class="post-date"><span class="day">02 </span>aug 2022     </span></div></a>
                <div class="post-summary">
                  ...
                  <div class="post-text"><a class="post-link" href="#0">
                    ...
                    <p class="post-excerpt">Lorem ipsum dolor sit, amet consectetur adipisicing elit.Iure nulla dolorem, voluptates molestiae</p><a class="read-more" href="#0" title="data analysis and the big impact on industry">read more<i class="bi bi-arrow-right icon "></i></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-12 col-lg-4 ">
              <div class="post-box">     <a class="post-link" href="#0" title="helping others can boost you happiness">
                  <div class="post-img-wrapper  "><img class=" parallax-img   post-img" loading="lazy" src="{{ asset('assets/images/blog/post-images/6.jpg') }}" alt=""/><span class="post-date"><span class="day">21 </span>jul 2022     </span></div></a>
                <div class="post-summary">
                  ...
                  <div class="post-text"><a class="post-link" href="#0">
                    ...
                    <p class="post-excerpt">Lorem ipsum dolor sit, amet consectetur adipisicing elit.Iure nulla dolorem, voluptates molestiae</p><a class="read-more" href="#0" title="helping others can boost you happiness">read more<i class="bi bi-arrow-right icon "></i></a>
                  </div>
                </div>
              </div>
            </div>
