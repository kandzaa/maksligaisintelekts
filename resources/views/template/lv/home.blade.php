            ...
            <div class="row g-0">
              <div class="col-12 col-lg-8 ">
                <div class="row ">
                  ...
                  <div class="col-12     ">
                    <div class="pre-title">Mārketings</div>
                    <h1 class="slide-title  ">Mārketings tavam <span class="featured-text">biznesam</span></h1>
                  </div>
                  <div class="col-10 ">
                  ...
                  <div class="col-12   ">
                    <div class="cta-links-area ">
                      <a class=" btn-solid cta-link  cta-link-primary  " href="#0">Sāc tagad</a>
            ...
            <div class="row g-0">
              <div class="col-12 col-lg-8 ">
                <div class="row ">
                  ...
                  <div class="col-12     ">
                    <div class="pre-title">IT Risinājumi</div>
                    <h1 class="slide-title  ">sniedzot labākos pakalpojumus un IT <span class="featured-text">risinājumus</span></h1>
                  </div>
                  <div class="col-10 ">
                    <p class="slide-subtitle ">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempore sint explicabo necessitatibus voluptates labore, dolorum dolorem laboriosam debitis ea delectus.</p>
                  </div>
                  <div class="col-12   ">
                    <div class="cta-links-area"><a class=" btn-solid cta-link cta-link-primary  " href="#0">Sāc tagad</a><a class=" btn-outline cta-link  " href="{{ route('contact.lv') }}">Kontakti      </a></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="row g-0">
              <div class="col-12 col-lg-8 ">
                <div class="row ">
                  ...
                  <div class="col-12     ">
                    <div class="pre-title">Datu analīze</div>
                    <h1 class="slide-title  ">Nodrošinot precīzu darbu, izmantojot datu <span class="featured-text">analīzi</span></h1>
                  </div>
                  <div class="col-10 ">
                    <p class="slide-subtitle ">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempore sint explicabo necessitatibus voluptates labore, dolorum dolorem laboriosam debitis ea delectus.</p>
                  </div>
...
<section class="blog blog-home mega-section  " id="blog">
  <div class="container ">
    <div class="sec-heading  ">
      <div class="content-area"><span class=" pre-title       wow fadeInUp " data-wow-delay=".2s">Ziņas</span>
        <h2 class=" title    wow fadeInUp" data-wow-delay=".4s">jaunākās <span class='hollow-text'>ziņas</span></h2>
      </div>
      <div class=" cta-area  cta-area  wow fadeInUp" data-wow-delay=".8s"><a class="cta-btn btn-solid   cta-btn btn-solid" href="{{ route('blog.lv') }}">skatīt visas ziņas<i class="bi bi-arrow-right icon "></i></a></div>
    </div>
    <div class="row ">
      <div class="col-12 ">
