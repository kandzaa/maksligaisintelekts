...
<section class="d-flex align-items-center page-hero  inner-page-hero " id="page-hero">
  ...
  <div class="container">
    <div class="hero-text-area centerd">
      <h1 class="hero-title  wow fadeInUp" data-wow-delay=".2s">Web Izstrāde</h1>
      <nav aria-label="breadcrumb ">
        <ul class="breadcrumb wow fadeInUp" data-wow-delay=".6s">
          ...
          <li class="breadcrumb-item active">Web Izstrāde</li>
        </ul>
      </nav>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-12 col-lg-8">
        <div class="service-content">
          <h2 class="section-title">Profesionāli Web Izstrādes Pakalpojumi</h2>
          <p class="service-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque repellendus minima reiciendis nobis dolore obcaecati. We create modern, responsive websites that help your business grow and succeed online.</p>
          ...
          <p class="process-description">We follow a systematic approach to ensure your website meets your business goals and exceeds your expectations.</p>
        </div>
      </div>
        ...
        <div class="service-sidebar">
          <div class="service-info-box">
            ...
            <ul class="info-list">
              ...
              <li><strong>Starting Price:</strong> From $2,500</li>
    ...
    <div class="row">
      <div class="col-12 col-md-6 col-lg-4">
        <div class="related-service-card">
          ...
          <a href="{{ route('contact.lv') }}/digital-marketing" class="read-more">Learn More</a>
        </div>
      </div>
      <div class="col-12 col-md-6 col-lg-4">
        <div class="related-service-card">
          ...
          <a href="{{ route('contact.lv') }}/seo-services" class="read-more">Learn More</a>
        </div>
      </div>
      <div class="col-12 col-md-6 col-lg-4">
        <div class="related-service-card">
          ...
          <a href="{{ route('contact.lv') }}/apps-development" class="read-more">Learn More</a>
        </div>
      </div>
    </div>
  </div>
